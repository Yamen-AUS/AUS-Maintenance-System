...
setTimeout(() => {
    ...
    console.log('editTask:', typeof window.editTask === 'function' ? '✅' : '❌');
    console.log('deleteTask:', typeof window.deleteTask === 'function' ? '✅' : '❌');
    console.log('renderTaskTable:', typeof window.renderTaskTable === 'function' ? '✅' : '❌');
    console.log('renderDashboard:', typeof window.renderDashboard === 'function' ? '✅' : '❌');
    console.log('renderAnalytics:', typeof window.renderAnalytics === 'function' ? '✅' : '❌');
    console.log('renderVendors:', typeof window.renderVendors === 'function' ? '✅' : '❌');
}, 1000);